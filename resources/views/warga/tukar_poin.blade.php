...
<div class="max-w-xl mx-auto space-y-6">
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Tukar Poin</h1>
            <p class="text-slate-500 text-sm">Pilih sayur segar dari petani lokal.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 text-center">
        ...
        <h2 class="text-xl font-bold text-slate-800 mb-2">Belum ada sayur tersedia</h2>
        <p class="text-slate-500">Saat ini belum ada panen yang dapat ditukarkan. Silakan cek kembali nanti.</p>
    </div>
</div>
@endsection
